...
import me.oneqxz.partyoverlay.server.listeners.*;
...
public class ServerConnection {
    ...
    public void init()
    {
        ...
        new Thread(() -> {
            ...
            eventRegistry.registerEvents(new FriendListener());
            ...
            try {
                ...
                ChannelFuture channelFuture = serverBootstrap.bind(25565).sync();
